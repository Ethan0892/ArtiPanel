...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onToggle }) => {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      path: '/gaming',
      subItems: [
        { id: 'gaming-list', label: 'Minecraft Servers', icon: '⛏️', path: '/gaming/minecraft' },
        { id: 'gaming-create', label: 'Deploy Game Server', icon: '🚀', path: '/gaming/create' },
      ],
    },
    {
      id: 'storage',
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: 'remote-files', label: 'File Manager', icon: '🗂️', path: '/remote/files' },
      ],
    },
  ];

...
start_services() {
    ...
    echo -e "  ${BLUE}Password:${NC} Configure DEFAULT_ADMIN_PASSWORD in backend/.env"
    echo ""
    echo -e "${RED}⚠️  IMPORTANT: Set a strong password in backend/.env before deploying!${NC}"
    echo ""
